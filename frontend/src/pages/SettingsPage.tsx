          ...
          <Grid item xs={12}>
            <Paper sx={{ p: 3 }}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  <Typography variant="subtitle2">Weaviate</Typography>
                  <Stack spacing={0.5}>
                    <Typography variant="body2">URL: {admin?.weaviate?.url}</Typography>
                    <Typography variant="body2">Class: {admin?.weaviate?.class}</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12} md={6}>
