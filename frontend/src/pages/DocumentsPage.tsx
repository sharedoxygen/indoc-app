...
import { Box, Typography, TextField, InputAdornment, Grid, Paper, Chip, IconButton, Tooltip, CircularProgress } from '@mui/material'
import { Search as SearchIcon, OpenInNew as OpenIcon, Chat as ChatIcon } from '@mui/icons-material'
...
const DocumentsPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Redirect to dashboard which hosts the search-driven list for now
